function [R, C, Risk] = FitnessFun4(I,Data,C_weight,alpha,R0,policy,RiskMeasure)
    C = TotalCost(Data.slacomp,Data.slacomp2,Data.alternativeslacomp,Data.demand,I.DNA,Data.cap,Data.noOfNodes);

    tmp = sum(Data.unpr(I.DNA(1,:)',:)) + sum(Data.ded(I.DNA(2,:)',:)) + sum(Data.lded(I.DNA(3,:)',:)) + sbppcost';    
