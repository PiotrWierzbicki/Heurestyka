...
for i1=1:3
    for i2=1:2
        for i3=1:2
            ...
            load([dirr, RRiskMeasure, '_', PPolicy, '_', NNet, '_1_', WWeight, '.mat' ]);
            load([dirr, 'Black_', RRiskMeasure, '_', PPolicy, '_', NNet, '_1_', WWeight, '.mat' ]);
...
%            plot(NewPop{1}.C,NewPop{1}.V,'Color', [0 0 1], 'Marker', '.', 'LineStyle', 'none','MarkerSize',20);
            ...
            load([dirr, RRiskMeasure, '_', PPolicy, '_', NNet, '_2_', WWeight, '.mat' ]);
...
%             hold on
 ...
 %           plot(NewPop{1}.C,NewPop{1}.V,'Color', [0 1 0], 'Marker', '.', 'LineStyle', 'none','MarkerSize',20);
            ...
            load([dirr, RRiskMeasure, '_', PPolicy, '_', NNet, '_3_', WWeight, '.mat' ]);
...
%             plot(CC0,VV0,'r.');
%             hold on
            load([dirr, RRiskMeasure, '_', PPolicy, '_', NNet, '_4_', WWeight, '.mat' ]);
            plot(CC,VV, 'Color', [0.8 0.8 0.8], 'Marker', '+', 'LineStyle', 'none','MarkerSize',2);
            hold on
 ...
 %           plot(NewPop{1}.C,NewPop{1}.V,'Color', [1 0 0], 'Marker', '.', 'LineStyle', 'none','MarkerSize',25);
            ...
            elseif(strcmp(RRiskMeasure,'cVar'));
                RRRiskMeasure = 'CVaR';
            elseif(strcmp(RRiskMeasure,'mean'));
                RRRiskMeasure = 'Risk Exposure';
            end
            
            
            ylabel(RRRiskMeasure);
            xlabel('Cost');
            print(['Figures/', RRiskMeasure, PPolicy, NNet, WWeight], '-dpng')
            end
        end
    end
end
