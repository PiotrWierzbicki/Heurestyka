...
function Slacomp2JsonNoRouterF(slacompName,lambdar,alpha,betam,wa,dstFile)
...
%weivar=wb^2(gamma(1+2/wa)-(gamma(1+1/wa)^2))
    ...
    dpa=alpha;
    dpb=beta;
    dlambda=expfromparetoS(dpa,dpb); %srednia exp taka jak dla pareto
    [dwa,dwb]=wblfromparetoS(dpa, dpb);
    [dlm,dls]=lognfromparetoS(dpa,dpb);
%     lambda
%     alpha
%     beta
