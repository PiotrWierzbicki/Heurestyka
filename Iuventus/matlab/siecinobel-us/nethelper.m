...
xslt('nobel-us.xml','net2nodes.xslt', 'nodes.txt');
xslt('nobel-us.xml','net2links.xslt', 'links.txt');
xslt('nobel-us.xml','net2demands.xslt', 'demands.txt');
...
for i=1:length(demand)
    ...
    routes2{i}=dijkstra(noOfNodes,1./A2,src,dst, farthestPreviousHop, farthestNextHop);
